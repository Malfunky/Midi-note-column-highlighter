-- changelog 
-- 5/11 - 2021 - Support for 13,9,7,6,altered fifths 
-- 5/13 - 2021 - Support for sus, add, aug ,maj -- must use lower case
...
-------------------------------------------
--     update not working when scrolling, until you move the mouse outside 
...
function getChord(chord)
    ...
    key = scaletable[root]
     ...
     leftover2 = string.gsub(leftover,"^[#b]", "")
    ...
    look_sus = string.find(leftover2,"sus") 
    leftover3_=string.gsub(leftover2,"maj7","#7") --maj7 should be before maj
    leftover3_=string.gsub(leftover3_,"maj","#7") 
    leftover3_=string.gsub(leftover3_,"sus2","9")
    leftover3_=string.gsub(leftover3_,"sus4","11")
    leftover3_=string.gsub(leftover3_,"add2","9")
    leftover3_=string.gsub(leftover3_,"aug5","#5")
    leftover3_=string.gsub(leftover3_,"aug6","#6")
    leftover3_=string.gsub(leftover3_,"add2","11")
    leftover3_=string.gsub(leftover3_,"add6","13")
    
    local _, _,minor_or_major = string.find(leftover3_,"^([m])") 
    leftover3=string.gsub(leftover3_,"^m","") 
    
    if not look_sus then 
    ...
    while pos do 
     ...
     -- _,pos,sign,digit=string.find(leftover3,"^([#b]?)([5679])",pos+1)
      _,pos,sign,digit=string.find(leftover3,"^([#b]?)([56791])", 0)
       leftover3 =string.gsub(leftover3,"^([#b]?)([56791])","")
       if digit =="1" then 
                 _,pos2,digit2=string.find(leftover3,"^([13])" ) 
                 leftover3 =string.gsub(leftover3,"^([13])","")
                 digit = digit..digit2 
       end 
